      ...
      <div className="col-span-3 lg:col-span-2">
        ...
        <div>
          <p className="text-start text-secondary-500 text-lg leading-loose">
            ...
            در بلاگ بایت، داستان‌ها و تجربیات خودم در زمینه برنامه‌نویسی و توسعه
            نرم‌افزار را با شما به اشتراک می‌گذارم.
            <br />
            اگر شما هم علاقه‌مند به فناوری و کدنویسی هستید و دوست دارید تجربیات
